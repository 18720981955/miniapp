...
public class CurrentUserMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        ...
        return parameter.getParameterType().isAssignableFrom(WxMaUserInfo.class)//判断是否能转成UserBase 类型
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        WxMaUserInfo user = (WxMaUserInfo) webRequest.getAttribute(CurrentUserConstants.CURRENT_USER, RequestAttributes.SCOPE_REQUEST);
        if (user != null) {
            return user;
        }
